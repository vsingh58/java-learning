 ...
 *
 */
@Description(name = "from_millseconds",
        value = "_FUNC_(unix_time, format) - returns unix_time(milliseconds of type long from 1970-01-01 00:00:00) in the specified format",
        extended = "Example:\n"
                + "  > SELECT _FUNC_(0, 'yyyy-MM-dd HH:mm:ss') FROM src LIMIT 1;\n"
                + "  '1970-01-01 00:00:00'")
public class FromMillSecondsTime extends UDF {
    private SimpleDateFormat formatter;

    private Text result = new Text();
    private Text lastFormat = new Text();

    public FromMillSecondsTime() {
    }
     ...
     *
     * @param unixtime
     *          milliseconds of type long from 1970-01-01 00:00:00
     * @param format
     *          display format. See
